...
# Print a line for for formatting purposes and 
print (f"a line for formatting ie:**************")
...
Spending_Money = ("Budget_per_day: 100. 0 USD ")

# Ask the user how much would they like to spend per day
input_Spending_Money = input("How much do I need to spending in a day: 20 ")
...
#Calculate the number of days hours, and minutes on jamaica trip
total_hours = "105.0 hr"
total_minutes = "6,300 mins:"
total_for_week = "4 days 9 hr:"
float = (input("hours for week, 105" "minutes for the week, 6,300 "  +  "numberof days, 4 days and 9 hours "))

#Create a while loop for Vacation Budget user
jamaican_trip = True
...
while jamaican_trip: 
   ...
   print(f"{first_name}  {last_name}  jamaica for 5 days with 100.00 for the week you will have 20.00 per day for spending money:")
